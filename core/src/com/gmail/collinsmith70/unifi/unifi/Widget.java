...
public class Widget
  ...
  @Override
  public final void setBounds(int left, int right, int top, int bottom) {
    if (right < left) {
  ...
  @Override
  @NonNull
  public final ImmutableBoundary getBounds() {
  ...
  @Override
  @NonNull
  public final ImmutablePoint2D getPosition() {
  ...
  @Override
  @NonNull
  public final ImmutableDimension2D getSize() {
