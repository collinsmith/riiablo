...
public class Padding extends Rect {

    public static final Padding ZERO = ImmutablePadding.newImmutablePadding();

    public Padding() {
        this(0, 0, 0, 0);
    }

    public Padding(@IntRange(from = 0, to = Integer.MAX_VALUE) int left,
    ...
    public Padding(@NonNull Rect src) {
        _set(src);
    }
    ...
    private void _set(@NonNull Padding src) {
