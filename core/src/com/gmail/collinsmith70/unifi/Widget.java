...
public abstract class Widget
        implements Bounded, com.gmail.collinsmith70.unifi.Paddable, com.gmail.collinsmith70.unifi.Marginable, com.gmail.collinsmith70.unifi.Translateable, Disposable {
  ...
  @Nullable
  private com.gmail.collinsmith70.unifi.WidgetParent parent;
   ...
   */
  @Nullable
  public final com.gmail.collinsmith70.unifi.WidgetParent getParent() {
    return parent;
  }
   ...
   */
  protected final void setParent(@Nullable final com.gmail.collinsmith70.unifi.WidgetParent parent) {
    if (getParent() == parent) {
      return;
    }
  ...
  /**
   * {@link com.gmail.collinsmith70.unifi.Window} instance containing this {@code Widget}.
   *
   ...
   */
  @Nullable
  public final com.gmail.collinsmith70.unifi.Window getWindow() {
    for (com.gmail.collinsmith70.unifi.WidgetParent parent = getParent(); parent != null; parent = parent.getParent()) {
      if (parent instanceof com.gmail.collinsmith70.unifi.Window) {
        return (com.gmail.collinsmith70.unifi.Window) parent;
      }
    }
  ...
  public boolean isDebug() {
    final com.gmail.collinsmith70.unifi.Window window = getWindow();
    if (window != null) {
   ...
   * </p>
   *
   * @param src {@code Boundary} to copy the margin onto this {@code Widget}
   */
  @Override
  @CallSuper
   ...
   *
   * @param debug {@code Drawable} to render when in debug mode, or {@code null} to remove
   *              the current background from this {@code Widget}.
   */
  @CallSuper
  public void setDebug(@Nullable final Drawable debug) {
    this.debug = debug;
  }
