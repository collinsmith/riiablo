...
//    //if ((flags & COMPACT) == 0) {
//      Stat prop;
//      if ((prop = item.attrs.agg.get(Stat.armorclass)) != null) {
//        Table t = new Table();
//        t.add(new Label(Riiablo.string.lookup("ItemStats1h") + " ", font));
//        t.add(new Label(Integer.toString(prop.val), font, item.attrs.get(Stat.armorclass).isModified() ? Riiablo.colors.blue : Riiablo.colors.white));
//        t.pack();
...
//          i = 1;
//        }
//        if ((i & 1) != 0 && (prop = item.attrs.agg.get(Stat.maxdamage)) != null) {
//          Table t = new Table();
//          t.add(new Label(Riiablo.string.lookup("ItemStats1l") + " ", font));
//          t.add(new Label(item.attrs.get(Stat.mindamage).val + " to " + prop.val, font, item.attrs.get(Stat.maxdamage).isModified() ? Riiablo.colors.blue : Riiablo.colors.white));
//          t.pack();
//          table.add(t).space(SPACING).row();
//        }
//        if ((i & 2) != 0 && (prop = item.attrs.agg.get(Stat.secondary_maxdamage)) != null) {
//          Table t = new Table();
//          t.add(new Label(Riiablo.string.lookup("ItemStats1m") + " ", font));
//          t.add(new Label(item.attrs.get(Stat.secondary_mindamage).val + " to " + prop.val, font, item.attrs.get(Stat.secondary_maxdamage).isModified() ? Riiablo.colors.blue : Riiablo.colors.white));
//          t.pack();
//          table.add(t).space(SPACING).row();
//        }
//        if (item.typeEntry.Throwable && (prop = item.attrs.agg.get(Stat.item_throw_maxdamage)) != null) {
//          Table t = new Table();
//          t.add(new Label(Riiablo.string.lookup("ItemStats1n") + " ", font));
//          t.add(new Label(item.attrs.get(Stat.item_throw_mindamage).val + " to " + prop.val, font, item.attrs.get(Stat.item_throw_maxdamage).isModified() ? Riiablo.colors.blue : Riiablo.colors.white));
//          t.pack();
//          table.add(t).space(SPACING).row();
//        }
//      }
//      if (item.type.is(Type.SHLD)) {
//        if ((prop = item.attrs.agg.get(Stat.toblock)) != null) {
//          Table t = new Table();
...
//          table.add(t).space(SPACING).row();
//        }
//        if (Riiablo.charData.classId == CharacterClass.PALADIN && (prop = item.attrs.agg.get(Stat.maxdamage)) != null && prop.val > 0)
//          table.add(new Label(Riiablo.string.lookup("ItemStats1o") + " " + item.attrs.agg.get(Stat.mindamage).val + " to " + prop.val, font, Riiablo.colors.white)).center().space(SPACING).row();
//      }
//      if (!item.base.nodurability && (prop = item.attrs.agg.get(Stat.durability)) != null)
//        table.add(new Label(Riiablo.string.lookup("ItemStats1d") + " " + prop.val + " " + Riiablo.string.lookup("ItemStats1j") + " " + item.attrs.agg.get(Stat.maxdurability).val, font, Riiablo.colors.white)).center().space(SPACING).row();
...
//      Stat stat = item.attrs.get(Stat.item_numsockets);
//      if (stat != null) {
