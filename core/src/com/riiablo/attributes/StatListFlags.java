...
public class StatListFlags {
  ...
  public static final int ITEM_MAGIC_LIST = 0;
  public static final int ITEM_SET_LIST   = 1;
  public static final int ITEM_RUNE_LIST  = 6;
  public static final int NUM_ITEM_LISTS  = 7;

  public static final int FLAG_NONE  = 0;
  public static final int FLAG_MAGIC = 1 << ITEM_MAGIC_LIST;
  public static final int FLAG_SET_2 = 1 << (ITEM_SET_LIST + 0);
  public static final int FLAG_SET_3 = 1 << (ITEM_SET_LIST + 1);
  public static final int FLAG_SET_4 = 1 << (ITEM_SET_LIST + 2);
  public static final int FLAG_SET_5 = 1 << (ITEM_SET_LIST + 3);
  public static final int FLAG_SET_6 = 1 << (ITEM_SET_LIST + 4);
  public static final int FLAG_RUNE  = 1 << ITEM_RUNE_LIST;
  ...
  public static final int GEM_WEAPON_LIST = 0;
  public static final int GEM_ARMOR_LIST  = 1;
  public static final int GEM_SHIELD_LIST = 2;
  public static final int NUM_GEM_LISTS   = 3;

  public static final int FLAG_WEAPON = 1 << GEM_WEAPON_LIST;
  public static final int FLAG_ARMOR  = 1 << GEM_ARMOR_LIST;
  public static final int FLAG_SHIELD = 1 << GEM_SHIELD_LIST;
