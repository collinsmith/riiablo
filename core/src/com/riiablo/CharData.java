...
public class CharData {
  ...
  public void updateD2S() {
    ...
    stats.put(Stat.statpts, d2s.stats.statPoints);
    stats.put(Stat.newskills, d2s.stats.skillPoints);
    stats.put(Stat.hitpoints, d2s.stats.life);
    stats.put(Stat.maxhp, d2s.stats.baseLife);
    stats.put(Stat.mana, d2s.stats.mana);
    stats.put(Stat.maxmana, d2s.stats.baseMana);
    stats.put(Stat.stamina, d2s.stats.stamina);
    stats.put(Stat.maxstamina, d2s.stats.baseStamina);
    stats.put(Stat.level, d2s.stats.level);
    stats.put(Stat.experience, (int) d2s.stats.xp);
    stats.put(Stat.gold, d2s.stats.invGold);
    stats.put(Stat.goldbank, d2s.stats.stashGold);
