...
import gdx.diablo.codec.DC;
import gdx.diablo.codec.DC6;
import gdx.diablo.codec.DCC;
import gdx.diablo.codec.Palette;
import gdx.diablo.graphics.PaletteIndexedBatch;
import gdx.diablo.mpq.widget.CollapsibleVisTable;
import gdx.diablo.mpq.widget.TabbedPane;
    ...
    public void create() {
      ...
      fileTree.addListener(new ChangeListener() {
        ...
        public void changed(ChangeEvent event, Actor actor) {
          ...
          Client.this.open(selection, node, handle);
      ...
      Diablo.batch = batch = new PaletteIndexedBatch(256, shader);
