...
public class Tester705 extends ApplicationAdapter {
  ...
  public static void main(String[] args) {
    ...
    new LwjglApplication(new Tester705(), config);
  }
  ...
  public void create() {
    ...
    DT1 dt1 = DT1.loadFromStream("data\\global\\tiles\\expansion\\Town\\walls.dt1",
        d2exp.read("data\\global\\tiles\\expansion\\Town\\walls.dt1"));

    tiles = new Texture[4];
    for (int i = 0; i < tiles.length; i++) {
      tiles[i] = new Texture(new PixmapTextureData(dt1.tile(i + 0), null, false, true, false));
    }
