...
public class Tester702 extends ApplicationAdapter {
  private static final String TAG = "Tester";

  public static void main(String[] args) {
    LwjglApplicationConfiguration config = new LwjglApplicationConfiguration();
    config.title = "Tester702";
    config.resizable = true;
    config.width = 640;
    config.height = 480;
    config.foregroundFPS = config.backgroundFPS = 144;
    new LwjglApplication(new Tester702(), config);
  }
  ...
  public void create() {
    ...
    DT1 dt1 = DT1.loadFromStream("data\\global\\tiles\\ACT1\\TOWN\\fence.dt1",
        d2data.read("data\\global\\tiles\\ACT1\\TOWN\\floor.dt1"));
